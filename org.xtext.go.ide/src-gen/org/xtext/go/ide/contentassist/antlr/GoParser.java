		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOperationsAccess().getGroup_0(), "rule__Operations__Group_0__0");
					...
					put(grammarAccess.getOperationsAccess().getOAssignment_0_1(), "rule__Operations__OAssignment_0_1");

 ...
 * <ul>
 *   <li>{@link org.xtext.go.go.Y#getO <em>O</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.go.go.GoPackage#getY()
 * @model
 * @generated
 */
public interface Y extends EObject
{
   ...
   * @see #setO(EObject)
   * @see org.xtext.go.go.GoPackage#getY_O()
  ...
  /**
   * Sets the value of the '{@link org.xtext.go.go.Y#getO <em>O</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

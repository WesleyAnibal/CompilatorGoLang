...
public class GoPackageImpl extends EPackageImpl implements GoPackage
{
   ...
   * @generated
   */
  public EReference getVariable_Cas()
  {
   ...
   * @generated
   */
  public EReference getVariable_K()
  {
   ...
   * @generated
   */
  public EReference getVariable_N()
  {
   ...
   * @generated
   */
  public EReference getAtrib_K()
  {
    return (EReference)atribEClass.getEStructuralFeatures().get(4);
  }
   ...
   * @generated
   */
  public EReference getReAtrib_K()
  {
    return (EReference)reAtribEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getSubtration_Left()
  {
    return (EReference)subtrationEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getSubtration_Right()
  {
    return (EReference)subtrationEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(variableEClass, VARIABLE__CAS);
    createEReference(variableEClass, VARIABLE__K);
    createEReference(variableEClass, VARIABLE__N);
    ...
    createEReference(atribEClass, ATRIB__K);
    ...
    createEReference(reAtribEClass, RE_ATRIB__K);
    ...
    createEReference(subtrationEClass, SUBTRATION__LEFT);
    createEReference(subtrationEClass, SUBTRATION__RIGHT);
  ...
  public void initializePackageContents()
  {
    ...
    variableEClass.getESuperTypes().add(this.getSwitchCase());
    variableEClass.getESuperTypes().add(this.getOperationsOneEquals());
    variableEClass.getESuperTypes().add(this.getoperationsOne());
    variableEClass.getESuperTypes().add(this.getExpression());
    atribEClass.getESuperTypes().add(this.getvarFor());
    reAtribEClass.getESuperTypes().add(this.getvarFor());
    ...
    initEReference(getVariable_Cas(), this.getCases(), null, "cas", null, 0, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getVariable_K(), this.getGreeting(), null, "k", null, 0, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getVariable_N(), this.getNumbers(), null, "n", null, 0, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getAtrib_K(), ecorePackage.getEObject(), null, "k", null, 0, 1, Atrib.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getReAtrib_K(), ecorePackage.getEObject(), null, "k", null, 0, 1, ReAtrib.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getSubtration_Left(), this.getExpression(), null, "left", null, 0, 1, Subtration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSubtration_Right(), this.getExpression(), null, "right", null, 0, 1, Subtration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

 ...
 *   <li>{@link org.xtext.go.go.ReAtrib#getK <em>K</em>}</li>
 * </ul>
 *
 ...
 * @generated
 */
public interface ReAtrib extends varFor
{
  /**
   ...
   * @see #setK(EObject)
   * @see org.xtext.go.go.GoPackage#getReAtrib_K()
   * @model containment="true"
   * @generated
   */
  EObject getK();
  ...
  /**
   * Sets the value of the '{@link org.xtext.go.go.ReAtrib#getK <em>K</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
